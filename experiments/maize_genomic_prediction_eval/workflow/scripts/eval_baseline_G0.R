...
if (is.null(opt$`hybrids-dir`) || is.null(opt$`nam-dir`) || is.null(opt$`ames-dir`) || is.null(opt$output)) {
  print_help(opt_parser)
  stop("Required arguments: --hybrids-dir, --nam-dir, --ames-dir, --output", call.=FALSE)
}
