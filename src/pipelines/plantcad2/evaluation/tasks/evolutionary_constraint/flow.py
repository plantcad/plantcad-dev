...
class EvolutionaryConstraintFlow(BaseFlow):
    ...
    def start(self):
        ...
        # Parse config and overrides from CLI
        self.config = super().resolve_config()

        # Set task-specific config for easier access
        self.task_config = self.config.tasks.evolutionary_constraint
